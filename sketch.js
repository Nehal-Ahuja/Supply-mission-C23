...
function setup() {
	...
	rect1_body=Bodies.rectangle(400,650,200,20,{isStatic:true});
	World.add(world,rect1_body);

	rect2=createSprite(300,610,20,100);
	rect2.shapeColor="red";
	rect2_body=Bodies.rectangle(350,600,20,100,{isStatic:true});
	World.add(world,rect2_body);
	
	rect3=createSprite(500,610,20,100);
	rect3.shapeColor="red";
	rect3_body=Bodies.rectangle(500,600,20,100,{isStatic:true});
